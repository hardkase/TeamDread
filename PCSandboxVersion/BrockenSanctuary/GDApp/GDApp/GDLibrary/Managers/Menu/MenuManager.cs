...
namespace GDLibrary
{
    public class MenuManager: DrawableGameComponent
    {
        ...
        private MenuItem menuVolumeUp, menuVolumeDown, menuVolumeMute, menuBack, menuBack2;
        ...
        private void HideMenu()
        {
            ...
            bPaused = true;
            game.CameraManager.ActiveCamera.StatusType = StatusType.Updated | StatusType.Drawn;
